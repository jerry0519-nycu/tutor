...
* **文法**：
  ...
  * 作形容詞時可用於抽象（narrow mind）或具體（narrow street）。
...
1. Tourists flocked to the mountain to see the sunrise.
   　（遊客蜂擁到山上看日出。）
...
* **片語：**
  ...
  * **the relevance of A to B**（A 與 B 的關聯性）
